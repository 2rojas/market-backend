...
const envSchema = z.object({
    ...
    JWT_SECRET: z.string().min(8, "El JWT_SECRET debe tener al menos 8 caracteres"),
    PORT: z.string().default("3000").transform(Number), // Transforma el string "3000" a número 3000
    JWT_REFRESH_SECRET: z.string().min(8, "El JWT_SECRET debe tener al menos 8 caracteres"),
